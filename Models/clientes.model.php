...
class Clase_Clientes
{
    ...
    public function correo_repetido($Correo)
    {
        try {
            $con = new Clase_Conectar_Base_Datos();
            $con = $con->ProcedimientoConectar();
            $cadena = "SELECT count(*) as correo_repetido FROM `clientes` WHERE `Correo`= '$Correo'";
            $result = mysqli_query($con, $cadena);
            return $result;
        } catch (Throwable $th) {
            return $th->getMessage();
    ...
    public function telefono_repetido($Telefono)
    {
        try {
            $con = new Clase_Conectar_Base_Datos();
            $con = $con->ProcedimientoConectar();
            $cadena = "SELECT count(*) as telefono_repetido FROM `clientes` WHERE `Telefono`= '$Telefono'";
            $result = mysqli_query($con, $cadena);
            return $result;
        } catch (Throwable $th) {
            return $th->getMessage();
